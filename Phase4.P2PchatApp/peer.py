...
class peerMain:
    ...
    def __init__(self):
        ...
        while choice1 !="1":
            ...
            elif choice1 == "6" and self.isOnline:
            ...
            elif choice1 == "REJECT" and self.isOnline:
    ...
    def udpServer(self, udp_port):
         ...
         if exited>0:
             ...
             for y in rooms.room_users:
                if udp_port==rooms.room_users:
                    rooms.room_users.remove(udp_port)
